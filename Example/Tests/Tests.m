...
#import <BoltsTask/Bolts.h>

// This test uses deprecated API. Until the API is actually deleted, just ignore the warnings,
// as I'm not submitting this code anyways.
